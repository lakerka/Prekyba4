...
public class TradesPanel extends JPanel implements ITradeReportHandler {
     ...
     * 
     */
    private static final long serialVersionUID = -2872321668654951172L;
	...
	public TradesPanel(MainController mainController) {
		...
		HtmlButton but = new HtmlButton( "Refresh") {
             ...
             * 
             */
            private static final long serialVersionUID = 4556471417458808760L;
	...
	private void onRefresh() {
		this.mainController.getTradeReportsHandler().reqExecutions( new ExecutionFilter(), this);
	}
