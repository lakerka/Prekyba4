...
public class ContractPanel extends JPanel {
    ...
    protected TCombo<SecType> securityType = new TCombo<SecType>(
            SecType.values());
    ...
    /**
     * 
     * Function gets ContractPanel instance GUI fields values and parses them into
     * required form. Parsed values area saved in instance fields.
     * 
     */
    public void onOK() {
